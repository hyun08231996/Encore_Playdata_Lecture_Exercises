...
//				new XmlBeanFactory(new FileSystemResource("./src/main/resources/config/userservice01.xml"));
		 ...
		 */
		ApplicationContext factory = new ClassPathXmlApplicationContext("/config/userservice01.xml"); // getBean() 하기전에 즉, client가 서비스를 요청하기전 이미 공장에서 빈을 생성해서 보관하고있다. "pre-loading", <load-on-startup>과 동일
