...
public class Programmer {
	...
	//right click, source -> generate 밑에서 새번째
	
	public Programmer() {}//기본생성자....하는일: 필드초기화를 안한다

	public Programmer(String name, MyDate birthday, float salary, int bonus) { //명시적 생성자...하는일: 필드초기화
		this.name = name;
